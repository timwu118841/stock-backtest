...
const runBacktest = async () => {
  if (!backtestForm.strategyName || !backtestForm.stockSymbol || !backtestForm.startDate || !backtestForm.endDate) {
  ...
  try {
    ...
    const payload = {
      ...
      stock_symbol: backtestForm.stockSymbol,
...
const renderCharts = () => {
  ...
  if (priceChartRef.value) {
    ...
    priceChartInstance.setOption({
      ...
      title: { text: '股價與移動平均線', left: 'center' },
      tooltip: { trigger: 'axis' },
      legend: { data: ['股價', 'MA Short', 'MA Long'], bottom: 0 },
    ...
    <el-card class="form-card" shadow="hover">
      ...
      <el-form :model="backtestForm" label-position="top">
        ...
        <div class="strategy-params">
          ...
          <el-row :gutter="24">
            <el-col :xs="24" :sm="12">
              <el-form-item :label="backtestForm.strategyType === 'DCA' ? '每月投入金額' : '每月存入資金'">
            ...
            <el-col :xs="24" :sm="12">
              <el-form-item :label="backtestForm.strategyType === 'DCA' ? '每月買入日 (1-28)' : '每月存錢日 (1-28)'">
                <el-input-number v-model="backtestForm.dcaDay" :min="1" :max="28" style="width: 100%" />
              </el-form-item>
            </el-col>
          </el-row>
